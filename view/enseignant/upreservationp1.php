...
<body>
    ...
    <div class="row justify-content-end">
		...
		<div class="jumbotron">
			<form action="http://localhost/brief5-exel-gestion-salles/enseignant/filterDure" method="post" >
				<div class="form-group">
                    ...
                    <?php foreach($tabg as $row){?>
					  <option value="<?php echo $row['id']?>" <?php if($r[0]['id_grp']==$row['id']){echo "selected";} ?> ><?php echo $row['libelle']?></option>
                      <?php }?>
					</select>
      			</div>
				<div class="form-group">
          			<label>Date:</label>
        			 <input type="date" class="form-control" value="<?php echo $r[0]['date']?>" name="date">
      			</div>
